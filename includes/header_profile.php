...
//желательно ошибки и успех вынести в отдельные функции и проверять там//
//сделать вывод сообщений об успехе или провале
$error = '';
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item">
							<a href="<?php echo get_url('includes/logout.php'); ?>" class="btn btn-primary">Сменить пользователя</a>
